...
local Window = OrionLib:MakeWindow({Name = "Zodiaco Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Zodiaco Hub"})
...
W:AddLabel("[+] Zodiaco Hub is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Zodiaco Hub(Noitification)",
